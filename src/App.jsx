...
function App() {
        ...
        <a class="hs-dark-mode-active:block hidden hs-dark-mode group flex items-center text-gray-600 hover:text-blue-600 font-medium dark:text-gray-400 dark:hover:text-gray-500" href="#!" data-hs-theme-click-value="light">
          ...
          <div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
            <button id="hs-dropdown-with-header" type="button" class="hs-dropdown-toggle inline-flex flex-shrink-0 justify-center items-center gap-2 h-[2.375rem] w-[2.375rem] rounded-full font-medium bg-white text-gray-700 align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white transition-all text-xs dark:bg-gray-800 dark:hover:bg-slate-800 dark:text-gray-400 dark:hover:text-white dark:focus:ring-gray-700 dark:focus:ring-offset-gray-800">
              <img class="inline-block h-[2.375rem] w-[2.375rem] rounded-full ring-2 ring-white dark:ring-gray-800" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Image Description"></img>
            </button>
  ...
  <div id="application-sidebar" class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 left-0 bottom-0 z-[60] w-64 bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 dark:scrollbar-y dark:bg-zinc-900 dark:border-gray-700">
    <div class="px-6">
      <a class="flex px-2 gap-2 text-xl font-semibold text-slate-700 dark:text-white" href="#" aria-label="Brand"> 
      <Layout />
       Studio-OS</a>
    </div>
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
      <ul class="space-y-1.5">
        <li>
          <a class="flex items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 font-semibold text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-zinc-950 dark:text-white" href="javascript:;">
            <Home size={20} strokeWidth={2}/>
            Tela Inicial
          </a>
        </li>
        <li>
          <a class="flex items-center gap-x-3.5 py-2 px-2.5 font-semibold text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:text-white" href="javascript:;">
            <CheckCheckIcon size={20} strokeWidth={2}/>
            Minhas Tarefas
          </a>
        </li>
        <li>
        ...
        <li>
          <a class="flex items-center gap-x-3.5 py-2 px-2.5 font-semibold text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:text-white" href="javascript:;">
            <FilesIcon size={20} strokeWidth={2}/>
            Orçamentos
          </a>
        </li>
        <li>
...
{/* 
        <li class="hs-accordion" id="account-accordion">
          <a class="hs-accordion-toggle flex font-semibold items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:hs-accordion-active:text-white" href="javascript:;">
