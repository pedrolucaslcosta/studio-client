          ...
          <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
            <div>
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400">
                Crie orçamentos, edite, baixe e mais.
              </p>
            </div>
            ...
            <div>
              <div class="inline-flex gap-x-2">
                ...
                <a class="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold  bg-slate-700 text-white hover:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800" href="#">
                  <PlusCircle size={20}/>
                  Novo Orçamento
                </a>
              </div>
